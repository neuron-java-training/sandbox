...
public class TestRunnerMain {
	...
	public static void main(String[] args) {
		...
		FileWriterS sdsd=new FileWriterS();
		System.out.println(sdsd.readFile().get(0).getResult());
		System.out.println(sdsd.readFile().get(1).getResult());
		System.out.println(sdsd.readFile().get(2).getResult());
