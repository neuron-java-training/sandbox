...
public class TestResult {
	...
	public void getResult() {
		System.out.println(name + ": initTime->" + (double) initTime / 1_000_000
				+ " ms |sortingTime->" + (double) sortingTime / 1_000_000 + " ms |getItemTime->"
				+ (double) getItemTime / 1_000_000 + " ms |deleteItemsByRangeTime->"
				+ (double) deleteItemsByRangeTime / 1_000_000 + " ms |duplicationClearTime->"
				+ (double) duplicationClearTime / 1_000_000);
	}
